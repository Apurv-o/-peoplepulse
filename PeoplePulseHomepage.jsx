        ...
        <Reveal>
          <div className="relative z-10">
            ...
            <p className="text-base mt-5 leading-relaxed max-w-md" style={{ color: T.muted }}>
              PeoplePulse turns simple weekly check-ins into meaningful engagement, sentiment, and
      ...
      <div className="max-w-5xl mx-auto">
        <Reveal>
          <SectionHeading
            center
            eyebrow="WORKFLOW"
            title="One minute. Every week. Better visibility."
            sub="A lightweight weekly rhythm that builds continuous organizational empathy."
          />
        </Reveal>
...
function FeatureGrid() {
  const features = [
    { icon: ClipboardList, t: "Weekly check-ins", d: "60-second frictionless employee experience that team members actually use." },
      ...
      <Reveal>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-xs text-white/60 mt-5">60-second weekly check-ins · Privacy-first · No credit card required</p>
          </div>
        </div>
      </Reveal>
    </section>
